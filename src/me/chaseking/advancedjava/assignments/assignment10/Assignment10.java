package me.chaseking.advancedjava.assignments.assignment10;
...
public class Assignment10 extends Application {
    ...
    protected class MultipleBallPane extends Pane {
        ...
        public void add() {
            ...
            int rMin = 2;
            int rMax = 20;
            int radius = rMin + (int) (Math.random() * (rMax - rMin));
        ...
        public void subtract(){
            ...
            for(Node child : getChildren()){
                if(child instanceof Ball){
                    ...
                    if(largest == null || ball.getRadius() > largest.getRadius()){
                        largest = ball;
                    }
                }
            }
            ...
            for (int i = 0; i < this.getChildren().size(); i++) {
                ...
                for (int j = i + 1; j < this.getChildren().size(); j++) {
                    ...
                    if (b.intersects(ball.getBoundsInLocal())) {
                        ...
                        Ball newBall = new Ball(x, y, radius, ball.getFill());
    ...
    class Ball extends Circle {
        ...
        Ball(double x, double y, double radius, Paint color){
            super(x, y, radius);
            setFill(color);
        }
    }
