 ...
 * @author Chase King
 */
public class RentCar implements PaneHolder {
    private BorderPane pane;
    private GridPane detailsPane;
    private ComboBox<String> carType;
    private TextField firstName;
    private TextField lastName;
    private TextField driversLicense;
    ...
    public RentCar(Customer customer){
        ...
        detailsPane.add(FinalProject.label("Drivers license:"), 0, 3);
        detailsPane.add(driversLicense = new TextField(), 1, 3);
        driversLicense.setPromptText("Enter your drivers license.");
        ...
        bottom.setPadding(customer.getPane().getPadding());
        bottom.setHgap(20);
    ...
    private void rent(Car car, String name){
        RentInfo rent = new RentInfo(name);

        rent.setDriversLicense(driversLicense.getText());
        car.setRent(rent);
